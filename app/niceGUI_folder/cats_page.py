    ...
    async def display_table(filtered_cats):
        ...
        for cat in filtered_cats:
            ...
            row = {
                ...
                'title': title_display,
                'haritage_number': cat.get('haritage_number', ''),
                'haritage_number_2': cat.get('haritage_number_2', ''),
                'eye_colour': cat.get('eye_colour', ''),
                'hair_type': cat.get('hair_type', ''),
                'colour': cat.get('colour', ''),
                'litter': cat.get('litter', ''),
                'dam': cat.get('dam', ''),
                'sire': cat.get('sire', ''),
                'litter_size_male': cat.get('litter_size_male', ''),
                'litter_size_female': cat.get('litter_size_female', ''),
                'tests': cat.get('tests', ''),
                'blood_group': cat.get('blood_group', ''),
                'gencode': cat.get('gencode', ''),
                'weight': cat.get('weight', ''),
                'birth_weight': cat.get('birth_weight', ''),
                'transfer_weight': cat.get('transfer_weight', ''),
                'breeding_lock': cat.get('breeding_lock', ''),
                'breeding_animal': cat.get('breeding_animal', ''),
                'kitten_transfer': cat.get('kitten_transfer', ''),
                'wcf_sticker': cat.get('wcf_sticker', ''),
                'birth_country': cat.get('birth_country', ''),
                'location': cat.get('location', ''),
                'association': cat.get('association', ''),
                'faults_deviations': cat.get('faults_deviations', ''),
                'jaw_fault': cat.get('jaw_fault', ''),
                'hernia': cat.get('hernia', ''),
                'testicles': cat.get('testicles', ''),
                'death_date': cat.get('death_date', ''),
                'death_cause': cat.get('death_cause', ''),
                'status': cat.get('status', ''),
                'features': cat.get('features', ''),
                'notes': cat.get('notes', ''),
                'show_results': cat.get('show_results', ''),
